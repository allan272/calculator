...
# ---------------------------------------------------------------------------
# Helpers: drive inputs and parse outputs
# ---------------------------------------------------------------------------
...
async def test_calculator(dut):
    ...
    uio = get_uio(dut)
    assert (uio & 0x0F) == 0, "Counter should be 0 after reset"
    assert ((uio >> 4) & 0xF) == 0, "Register should be 0 after reset"
